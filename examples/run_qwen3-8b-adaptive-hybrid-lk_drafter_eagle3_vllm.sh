...
# GPU example for EAGLE3 with adaptive hybrid LK loss on vLLM.
project_name='verl_grpo_example_eagle3_adaptive_hybrid_lk'
exp_name='qwen3_8b_eagle3_adaptive_hybrid_lk_vllm_gpu'
...
PYTHONUNBUFFERED=1 python3 -m verl_speco.main \
    ...
    actor_rollout_ref.rollout.drafter.training.eagle3_ce_loss_alpha=0.0 \
    actor_rollout_ref.rollout.drafter.training.eagle3_lk_loss_alpha=1.0 \
    actor_rollout_ref.rollout.drafter.training.eagle3_lk_loss_type=adaptive_hybrid \
    actor_rollout_ref.rollout.drafter.training.eagle3_lk_hybrid_eta=1.0 \
    actor_rollout_ref.rollout.drafter.training.lk_temperature=0.6 \
    actor_rollout_ref.rollout.drafter.training.target_lm_head_row_restricted_sync=True \
    ...
    actor_rollout_ref.rollout.drafter.training.lr=3e-6 \
    actor_rollout_ref.rollout.drafter.training.ttt_length=3 \
    actor_rollout_ref.rollout.drafter.training.lr_scheduler_type=global_cosine \
    actor_rollout_ref.rollout.drafter.training.lr_warmup_steps=100 \
    actor_rollout_ref.rollout.drafter.training.lr_decay_steps=1000 \
