...
# GPU example for DSpark with pure LK loss on vLLM.
project_name='verl_grpo_example_dspark_lk_loss'
exp_name='qwen3_8b_dspark_lk_loss_vllm_gpu'
...
PYTHONUNBUFFERED=1 python3 -m verl_speco.main \
    ...
    actor_rollout_ref.rollout.drafter.training.dspark_ce_loss_alpha=0.0 \
    actor_rollout_ref.rollout.drafter.training.dspark_l1_loss_alpha=0.0 \
    actor_rollout_ref.rollout.drafter.training.dspark_lk_loss_alpha=1.0 \
