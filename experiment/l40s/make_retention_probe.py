...
def main() -> None:
    ...
    # The overlay must be self-contained: copy the whole package so relative imports resolve
    # against the audited copy instead of falling back to the base checkout.
